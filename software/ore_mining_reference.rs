// This file includes reference mining logic adapted from ORE.
// Original source: https://github.com/regolith-labs/ore/tree/master/program/src
// Used here for conceptual clarity and eventual integration.
